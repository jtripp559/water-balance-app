...
import { GldasIdentifyTaskResultsByMonth } from '../../services/GLDAS/GLDAS';
...
const MonthlyTrendChart: React.FC<Props> = ({
    ...
    return (
        <div
            ...
            // }}
        >
            <Header activeLayer={activeLayer} timeExtentItem={timeExtentItem} />

            <SvgContainer xDomain={getXDomain()} yDomain={getYDomain()}>
                <Lines
                    data={getDataForLines()}
                    activeLayer={activeLayer}
                    index4SelectedMonth={
                        timeExtentItem ? timeExtentItem.date.getMonth() : -1
                    }
                />
                ...
                <MouseEventsRect onHover={setItemOnHOver} />
            </SvgContainer>
        </div>
    );
};
