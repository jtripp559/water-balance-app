...
const TopNav: React.FC<Props> = ({ infoIconOnClick }) => {
    return (
        <TopNavContainer>
            <TitleText>Water Balance App</TitleText>
            <div>
                <span className="font-size--2 tablet-hide margin-right-half">
                    Click anywhere on earth to see how the water balance is
                    changing over time
                </span>

                <span
                    className="font-size--1 icon-ui-question cursor-pointer"
